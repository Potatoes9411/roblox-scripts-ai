...
--   Lifting Simulator.
--
--  Tested in Roblox Studio.   v2.0  (Mega build)
--====================================================================
--====================================================================
...
local VirtualInputManager  = (game.GetService and game:GetService("VirtualInputManager")) or nil
...
--====================================================================
local flyOn, flyOff, applyMovement
local noclipOn, noclipOff, infJumpOn, infJumpOff
local swimOn, swimOff, antiFlingOn, antiFlingOff, noFallOn, noFallOff
local espOn, espOff, fbOn, fbOff, fogOn, fogOff, nightOn, nightOff
local aimbotOn, aimbotOff, silentOn, silentOff, triggerOn, triggerOff
local hitboxOn, hitboxOff, autoFireOn, autoFireOff, autoParryOn, autoParryOff
local autoCollectOn, autoCollectOff, autoRobOn, autoRobOff, autoPlantOn, autoPlantOff
local godOn, godOff, auraOn, auraOff, antiAfkOn, antiAfkOff
local clickTpOn, clickTpOff, autoClickOn, autoClickOff
local partESPOn, partESPOff
...
local function buildGameWindow(g)
    ...
    settingsTab:AddLabel("UNIVERSAL GAME HUB — MEGA v2.0", Theme.Accent2, 14)
...
local function buildHub()
    ...
    Sub.Text = "MEGA • " .. #GameList .. " games • v2.0"
    Sub.Parent = Top
...
-- build every game window once + a list button for each
for _, g in ipairs(GameList) do
    gameWindows[g.key] = buildGameWindow(g)
    ...
    b.MouseButton1Click:Connect(function()
        gameWindows[g.key]:Show()
        Notify("Opened", g.name .. " menu", acc)
    end)
    hubButtons[g.key] = b
end
Hub.applyFilter()
...
print("============================================================")
print("[UniversalGameHub] LOADED — " .. #GameList .. " games available. v2.0 MEGA")
