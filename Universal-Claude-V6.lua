...
local function buildUniversal()
	...
	local sections = {
		...
		{ name = "Experimental Features", features = {
			...
			{ type = "toggle", label = "Smart Target Selection", key = "SmartTarget" },
			{ type = "toggle", label = "Adaptive Smoothing", key = "AdaptiveSmooth" },
			{ type = "toggle", label = "Projectile Prediction", key = "ProjectilePred" },
...
EXTRA.Arsenal = {
	{ name = "Arsenal — Game Sense", features = {
		{ type = "label", text = "Arsenal is a round-based gun-game. Aim for heads to fast-swap weapons." },
...
EXTRA.Jailbreak = {
	...
	{ name = "Jailbreak — Auto-Rob System", features = {
		{ type = "label", text = "Automated robbery sequences (experimental)." },
		{ type = "toggle", label = "Auto-Rob Master Switch", key = "AutoRobMaster" },
		{ type = "toggle", label = "Auto Bank (full sequence)", key = "AutoBank" },
		{ type = "toggle", label = "Auto Jewelry (full sequence)", key = "AutoJewel" },
		{ type = "toggle", label = "Auto Museum (full sequence)", key = "AutoMuseum" },
		{ type = "toggle", label = "Auto Collect After Rob", key = "AutoPostCollect" },
		{ type = "slider", label = "Rob Delay (seconds)", key = "RobDelay", min = 0, max = 10 },
		{ type = "toggle", label = "Notify on Robbery Start", key = "NotifyRob" },
	}},
...
EXTRA.MurderMystery2 = {
	{ name = "MM2 — Roles & Detection", features = {
		{ type = "label", text = "Color-coded ESP reveals roles. Red=Murderer, Blue=Sheriff, Green=Innocent." },
		{ type = "toggle", label = "Role ESP (master)", key = "ESP" },
		{ type = "toggle", label = "Auto-Detect Roles", key = "AutoDetectRoles" },
...
EXTRA.TowerOfHell = {
	{ name = "ToH — Cheats", features = {
		{ type = "label", text = "Reach the top fast. NoClip + Auto Complete skips the whole tower." },
		{ type = "toggle", label = "No Clip", key = "NoClip" },
		{ type = "toggle", label = "Auto Complete (TP to top)", key = "AutoComplete" },
...
EXTRA.DaHood = {
	{ name = "Da Hood — Aimlock", features = {
		{ type = "label", text = "Aimlock locks your camera. Silent Aim redirects shots without moving aim." },
		{ type = "toggle", label = "Aimbot / Aimlock", key = "Aimbot" },
		{ type = "toggle", label = "Silent Aim", key = "SilentAim" },
		{ type = "toggle", label = "Trigger Bot", key = "RapidFire" },
		{ type = "toggle", label = "FOV Circle", key = "FOVCircle" },
...
EXTRA.BeeSwarm = {
	{ name = "Bee Swarm — Farming Core", features = {
		{ type = "label", text = "Collect tokens/bubbles automatically and convert pollen to honey." },
		{ type = "toggle", label = "Master Auto-Farm", key = "MasterFarm" },
		{ type = "toggle", label = "Auto Collect Tokens", key = "AutoCollect" },
