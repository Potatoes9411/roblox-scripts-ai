...
EXTRA.Arsenal = {
	{ name = "Arsenal — AI Recoil Compensation", features = {
		{ type = "label", text = "🤖 ADVANCED: Learn weapon recoil patterns and auto-compensate." },
...
EXTRA.Jailbreak = {
	...
	{ name = "Jailbreak — Vehicle AI", features = {
		{ type = "label", text = "Intelligent vehicle control and automation." },
